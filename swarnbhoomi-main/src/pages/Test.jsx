  ...
  return (
    <div className="max-w-4xl mx-auto p-4 space-y-6 text-sm sm:text-base">
      ...
      <div className="grid grid-cols-2 gap-3">
        <input type="number" value={lat} onChange={(e) => setLat(parseFloat(e.target.value))} className="border p-2 rounded" placeholder="Latitude" />
        <input type="number" value={lng} onChange={(e) => setLng(parseFloat(e.target.value))} className="border p-2 rounded" placeholder="Longitude" />
        <input type="text" value={cropName} onChange={(e) => setCropName(e.target.value)} className="border p-2 rounded col-span-2" placeholder="Crop Name" />
        <select value={growthStage} onChange={(e) => setGrowthStage(e.target.value)} className="border p-2 rounded">
